...
mkdir -p "$1/Adobe-Photoshop/drive_c/Program Files/Adobe"
mv "$HOME/.config/setup/programs/Adobe Photoshop 2021" "$1"/Adobe-Photoshop/drive_c/Program\ Files/Adobe/Adobe\ Photoshop\ 2021
